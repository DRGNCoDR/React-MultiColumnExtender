...
(function () {
	...
	*/
	...
	function deepClone(source) {
	  if (/*#__PURE__*/ /*#__PURE__*/reactExports.isValidElement(source) || reactIsExports.isValidElementType(source) || !isPlainObject(source)) {
	    return source;
	  }
	  const output = {};
	...
	function deepmerge(target, source, options = {
	  ...
	  if (isPlainObject(target) && isPlainObject(source)) {
	    Object.keys(source).forEach(key => {
	      if (/*#__PURE__*/ /*#__PURE__*/reactExports.isValidElement(source[key]) || reactIsExports.isValidElementType(source[key])) {
...
export default theme;`;
	...
	var OpenInFullIcon = createSvgIcon(/*#__PURE__*/jsxRuntimeExports.jsx("path", {
	  d: "M21 11V3h-8l3.29 3.29-10 10L3 13v8h8l-3.29-3.29 10-10z"
	}), 'OpenInFull');

	var CloseFullscreenIcon = createSvgIcon(/*#__PURE__*/jsxRuntimeExports.jsx("path", {
